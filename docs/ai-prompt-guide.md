...
ArtPrep의 핵심 기능인 GPT-4 기반 실기자료 5단계 분석 프롬프트 가이드입니다.
...
| 항목 | 예상 비용 |
|------|----------|
| GPT-4o 입력 (텍스트 1000 tokens) | $0.005 |
| GPT-4o Vision (이미지 1장) | $0.01~0.02 |
| 작품 1건당 분석 비용 | 약 $0.03~0.05 |
| 캐싱으로 절약 | 동일 작품 재분석 없음 |

**무료 티어 한도**: Supabase Edge Function 500K req/월

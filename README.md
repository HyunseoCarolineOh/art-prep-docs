...
| **팀·외부 협력** | `docs/business-plan/business-plan-V9.md` §4.1.2 | 2026-05 외부 데이터분석가 1인 콜라보 합류, 6월 내 데이터 파이프라인·대시보드·모델 학습 완료 예정 |
...
- **HTML 장표(슬라이드 deck)는 [docs/STYLE_GUIDE.md](docs/STYLE_GUIDE.md) 규칙을 따름.** 외부 발표·지원사업 제출·내부 회의록 3가지 카테고리별 스타일·사이즈·색·파일 위치 규정.
